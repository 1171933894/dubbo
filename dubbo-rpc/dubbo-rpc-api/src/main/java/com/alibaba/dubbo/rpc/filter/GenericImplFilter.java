...
public class GenericImplFilter implements Filter {
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        if (ProtocolUtils.isGeneric(generic)// 泛化实现的调用
            ...
            Result result = invoker.invoke(invocation2);// 【第二步】RPC 调用

            if (!result.hasException()) {// 【第三步】反序列化正常结果
                ...
                try {
                    ...
                    try {
                        targetException = (Throwable) clazz.newInstance();// 创建原始异常
                    } catch (Throwable e) {
                        lastException = e;
                    ...
                    if (targetException != null) {// 设置异常的明细
                        try {
                        ...
                        result = new RpcResult(targetException);// 创建新的异常 RpcResult 对象
